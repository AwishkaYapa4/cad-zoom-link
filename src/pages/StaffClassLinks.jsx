// src/pages/StaffClassLinks.jsx
import { useEffect, useMemo, useState } from 'react'
import { useSearchParams } from 'react-router-dom'
import { CalendarClock, CalendarPlus, CalendarDays, Clock3, Inbox, Loader2, X } from 'lucide-react'
...
// Read-only Class Links view: staff can view class details and join classes, but cannot add, edit, delete, or mark complete.
export default function StaffClassLinks() {
