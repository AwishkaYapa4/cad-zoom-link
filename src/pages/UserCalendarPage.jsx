...
//
// Read-only calendar for staff. Reached from the staff "Calendar" tab at
// /staff/calendar. Deliberately does not import useClassActions or any
// mutation helper — same read-only posture as UserCourseDetails.jsx. Class
// details open via the existing modal with canEdit={false}, so staff can
// see the Zoom link and schedule but never edit, delete, or mark complete.
