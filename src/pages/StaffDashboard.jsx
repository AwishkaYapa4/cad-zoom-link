...
import { CalendarDays, Clock3, Inbox, Loader2 } from 'lucide-react'
...
// Read-only dashboard: staff can view and join classes, but cannot add or delete.
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-slate-500">View Zoom links for all upcoming classes.</p>
        </div>
