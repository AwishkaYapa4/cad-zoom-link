// src/components/CourseDetailsContent.jsx
//
// Admin-only course details content: course header, stats/progress, and the
// classes table with Edit/Delete/Mark Completed/Mark Pending/Add Class.
// Shared by two call sites:
//   - src/pages/AdminCourseDetails.jsx (route /admin/course/:courseId, shows
//     a "Back to Dashboard" link since it's a full page)
//   - src/components/CourseDetailsModal.jsx (opened as an overlay from the
//     Dashboard's "View Details" button, shows a close (X) button instead)
...
export default function CourseDetailsContent({ courseId, onClose }) {
  ...
  if (loading) {
    return (
      <>
        {!onClose && <Skeleton className="mb-4 h-4 w-32" />}
